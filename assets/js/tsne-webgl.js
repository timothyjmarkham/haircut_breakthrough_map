...
var imageData = {};
var imageDataKeys = [];
selectedBrands = 'Great|Fantastic|Sport|Super';
...
function loadData() {
  get('brand_counts.json', function(data) {
    ...
    brandCounts = [
    {x: "Great Clips", value: brandCountsHolder["Great"]},
    {x: "Fantastic Sams", value: brandCountsHolder["Fantastic"]},
    {x: "Sport Clips", value: brandCountsHolder["Sport"]},
    {x: "Superclips", value: brandCountsHolder["Super"]}
];
  })    
...
function addWindowEventListeners() {
  ...
  window.addEventListener('hashchange', function(e) {
    ...
    marker.XPos = (((coords.x + 2740)/(10380 + 2740)) * 300) - (marker.Width / 2);
    marker.YPos = (193 - ((coords.y + 18240)/(12448 + 18240)) * 193) - marker.Height;
    ...
    clusterCounts = [
    {x: "Great Clips", value: thisClusterData["Great"]},
    {x: "Fantastic Sams", value: thisClusterData["Fantastic"]},
    {x: "Sport Clips", value: thisClusterData["Sport"]},
    {x: "Superclips", value: thisClusterData["Super"]}
    ]
...
mapSprite.src = "assets/images/Haircut Full Map.png";
